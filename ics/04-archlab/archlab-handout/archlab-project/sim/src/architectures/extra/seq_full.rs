...
bool instr_valid = icode in // CMOVX is the same as RRMOVQ
    ...
    OPQ, JX, CALL, RET, PUSHQ, POPQ, IOPQ }; //1

// Does fetched instruction require a regid byte?
bool need_regids =
    icode in { CMOVX, OPQ, PUSHQ, POPQ, IRMOVQ, RMMOVQ, MRMOVQ, IOPQ }; //2

// Does fetched instruction require a constant word?
bool need_valC = icode in { IRMOVQ, RMMOVQ, MRMOVQ, JX, CALL, IOPQ }; //3
...
u8 srcB = [
    icode in { OPQ, RMMOVQ, MRMOVQ, IOPQ } : ialign.rB; //4
...
u8 dstE = [
    ...
    icode in { IRMOVQ, OPQ, IOPQ } : ialign.rB; //5
    icode in { PUSHQ, POPQ, CALL, RET } : RSP;
...
u64 aluA = [
    ...
    icode in { IRMOVQ, RMMOVQ, MRMOVQ, IOPQ } : ialign.valC; //6
...
u64 aluB = [
    icode in { RMMOVQ, MRMOVQ, OPQ, CALL,
              PUSHQ, RET, POPQ, IOPQ } : reg_read.valB; //7
...
bool set_cc = icode in { OPQ, IOPQ }; //9
